...
// AUTHOR: MORRIS, CHRIS	
// FILENAME: Lab5.java	
// SPECIFICATION: Designing patterns by Loops
// FOR: CSE_110, LAB #3
// TIME SPENT: 3hrs 40mins
//-----------------------------------------------------------*/
...
public class Lab5 {
    public static void main(String[] args) {
        ...
        do {
            ...
            case 'p':
                ...
                if ((numSymbols > 0) && (numSymbols % 2) != 0) {
                	scanner.nextLine();  // Flush junk newline symbols

                    System.out.println();
                    System.out.println(buildPyramid(SIDE_SYMB, MID_SYMB, numSymbols));
                }
                else if (numSymbols > 0 && (numSymbols % 2 ==0 ))
                {
                	...
                	System.out.println("Please enter an ODD number > 0");
                }
    ...
    private static String buildDiamond(
        ...
        int totalSymbMidRow = numSymbols;
        
        // YOUR CODE HERE
        // -->
        for (int numStars = numSymbols - 2; numStars >= 1; numStars -= 2 ) {
        	int numDashed = (totalSymbMidRow - numStars) / 2;
        	String row = buildRow(sideSymb, numDashed, midSymb, numStars );
        	result += row + "\n";
        }
        return result;
